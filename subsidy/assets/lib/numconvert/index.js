...
(function(){
  ...
  numconvert = {
    ...
    a2c: function(num, opt, inner){
      ...
      if (opt.dollar && this.re.dollar.exec(num + "")) {
        ...
        if (num.length > 0) {
          v = this.a2c(num.splice(0, 1)[0], opt, true);
          if (opt.uppercase) {
            v = this.l2u(v);
          }
      ...
      for (i$ = 0, to$ = this.base.length; i$ < to$; ++i$) {
        i = i$;
        if (opt.partial && ((opt.partial === true && this.base[i][1] <= 10) || (opt.partial !== true && !in$(this.base[i][0], opt.partial)))) {
          continue;
        }
        if (num >= this.base[i][1]) {
          ...
          ret = this.a2c(num1, opt, true) + "" + this.base[i][0] + deco + this.a2c(num2, opt, true);
          if (opt.uppercase) {
            ret = this.l2u(ret);
          }
          return ret;
      ...
      ret = !opt.partial ? this.map.lc.charAt(num) : num;
      if (opt.uppercase) {
        ret = this.l2u(ret);
      }
      return ret;
  ...
  if (typeof window != 'undefined' && window !== null) {
    window.numconvert = numconvert;
  }
  if (typeof module != 'undefined' && module !== null) {
    return module.exports = numconvert;
  }
})();
function in$(x, xs){
